...
import TextInput from '../../Component/Form/DescriptionInput';
import TextArea from '../../Component/Form/FormInput';
...
const AboutPage = ({ pristine, submitting,UpdateUser, handleSubmit }) => {
  return (
    <Segment>
